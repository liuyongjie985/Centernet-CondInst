...
class Tester():
    ...
    def infer(self, file_dir, out_dir):
        ...
        for file in tqdm(files):
            ...
            json.dump(res_dict, 
                open(os.path.join(out_dir, 'res', file.replace('.png', '.json')), 'w'), indent=4)
...
if __name__ == '__main__':
    ...
    arch = 'res_101'
    load_model = '/search/odin/yongjie/code/CenterNet-Condinst/Centernet-CondInst/exp/ctseg/default/model_best.pth'
    ...
    file_dir = '/search/odin/yongjie/code/CenterNet-Condinst/Centernet-CondInst/data/sogou/test'
    out_dir = 'temp_res'
